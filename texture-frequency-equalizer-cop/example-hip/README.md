...
## How To Use:
Make sure to download the [Texture Frequency Equalizer HDA](./../cop_cb_texture_frequency_equalizer.1.0.hdalc) and import into Houdini with File > Import > Houdini Digital Asset.

Read the root level [Texture Frequency Equalizer README](./../README.md) for more info.
