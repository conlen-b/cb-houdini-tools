...
- **[Texture Frequency Equalizer COP HDA:](/sinkhorn-texture-frequency-equalizer-cop-log-domain-optimal-transport/)** A Houdini Digital Asset (HDA) for the COP level that allows you to art-direct the 
