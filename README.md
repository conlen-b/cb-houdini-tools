...
- **[Texture Frequency Equailzer COP HDA:](/sinkhorn-based-log-domain-optimal-transport/)** A Houdini Digital Asset (HDA) for the COP level that allows you to art-direct the 
